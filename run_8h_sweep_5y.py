...
for offset, label in offsets:
    t0 = time.time()
    r = rust_engine.run_candle_miner_py(c, h, l, bv, sv, oi, offset, BP_8H)
...
# Quantile
print("QUANTILE MONOTONLUK (8H, 5Y)")
print("=" * 110)
...
# Ozet
print()
print("OZET: EN IYI PATTERN RATE BY OFFSET (8H, 5Y)")
print("=" * 110)
