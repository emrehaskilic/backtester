...
for offset, label in offsets:
    t0 = time.time()
    r = rust_engine.run_candle_miner_py(c, h, l, bv, sv, oi, offset, BP_1W)
...
# Quantile
print("QUANTILE MONOTONLUK (1W, 5Y)")
print("=" * 110)
